 ...
 * Мета: Розробити функцію setUserInfoCookie, яка встановлює cookie з ім'ям userInfo та значенням у форматі "ключ=значення", 
 * яке зберігає корисну інформацію про користувача (наприклад, обрану мову інтерфейсу) та має термін дії 10 секунд. 
...
function setUserInfoCookie(key, value) {
  ...
  // document.cookie = `userInfo=${data}; expires=${expires.toUTCString()}; path=/`;

  console.log('User info cookie set successfully.');
}
